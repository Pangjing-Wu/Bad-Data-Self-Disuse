...
nohup python -u scripts/metadata/consistence.py --dataset $dataset --cuda 1 2>&1 >/dev/null &
nohup python -u scripts/metadata/el2n.py --dataset $dataset --cuda 1 2>&1 >/dev/null &
...
nohup python -u scripts/metadata/isolation-forest.py --dataset $dataset --cuda 1 2>&1 >/dev/null &
nohup python -u scripts/metadata/oc-svm.py --dataset $dataset --cuda 1 2>&1 >/dev/null &
wait
