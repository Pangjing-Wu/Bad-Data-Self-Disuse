...
sys.path.append('.')
import configs
from component_scores import Centroid
...
def main(args, logger, filepath):
    ...
    ret = pd.DataFrame(dict(scores=scorer.scores()))
    logger.info(f'centroid of data:\n{scorer.centroids}')
    logger.info(f'radius of data:\n{scorer.radiuses}')
...
# python -u ./scripts/component-scores/centroid.py --dataset cifar10 --embed_net 'resnet18' --embed_dataset 'imagenet1k' --embed_algo 'pt' --embed_date '666666-6666' --dist euclidean --pca_dim 50 --cuda 0 --debug
