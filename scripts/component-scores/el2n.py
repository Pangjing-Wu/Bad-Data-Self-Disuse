...
def parse_args():
    parser = argparse.ArgumentParser(description='EL2N Evaluation')
...
def main(args, logger, filepaths):
    ...
    for r, seed in enumerate(args.seed):
        ...
        # reset scorer.
        scorer = EL2N(model=model, n_classes=len(dataset.classes), order=args.order)
...
# python -u ./scripts/component-scores/el2n.py --dataset cifar10 --net resnet18 --epoch 1 2 3 4 5 --lr 1e-3 --bs 128 --seed 0 1 --cuda 1 --debug
