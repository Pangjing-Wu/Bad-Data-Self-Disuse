...
def parse_args():
    parser = argparse.ArgumentParser(description='Probability Margin Evaluation (Finetune Version)')
...
def main(args, logger, filepaths):
    # log parameters.
    logger.info(f'====== Calculate Probability Margin Score (Finetune Version) ======')
...
# python -u ./scripts/component-scores/margin-ft.py --dataset cifar10 --embed_net vit --embed_dataset imagenet21k --embed_date '666666-6666' --epoch 1 2 3 4 5 --lr 1e-2 --bs 128 --seed 0 1 --cuda 0 --debug
