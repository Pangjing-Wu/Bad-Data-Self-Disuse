...
def parse_args():
    parser = argparse.ArgumentParser(description='Area Under Margin Evaluation')
...
def main(args, logger, filepath):
    # log parameters.
    logger.info(f'====== Calculate Area Under Margin Score ======')
...
# python -u ./scripts/component-scores/aum.py --dataset cifar10 --net resnet18 --epoch 5 --lr 1e-3 --bs 128 --seed 0 1 --cuda 1 --debug
