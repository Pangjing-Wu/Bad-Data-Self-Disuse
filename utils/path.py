...
__all__ = ['set_dataset_path', 'get_dataset_path', 'set_dataset_log_path',
           'set_embedding_path', 'set_embedding_log_path',
           'set_component_path', 'set_component_log_path',
           'set_component_collection_path', 'set_component_collection_log_path',
           'set_eval_path', 'set_eval_log_path',
           'set_performance_path', 'set_performance_log_path']
